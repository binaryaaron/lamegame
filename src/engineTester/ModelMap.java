...
//      ModelTexture yTexture = new ModelTexture(loader.loadTexture("font"));
      ...
      TexturedModel texturedHealth = new TexturedModel("H002",healthLabel, textTx);
      ...
      TexturedModel texturedY = new TexturedModel("H005",yLabel, textTx);
	    ...
	    TexturedModel texturedModelAsteroid2 = new TexturedModel("A002",stoneAsteroid,stoneTexture);
	    ...
	    TexturedModel texturedPlanet = new TexturedModel("Plan",planetObj, planetTexture);
	    TexturedModel texturedLaser = new TexturedModel("lase",laserObj, laserTexture);
