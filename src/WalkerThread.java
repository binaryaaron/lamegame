  ...
  public void run()
  {
    try
    {
      ObjectOutputStream outToClient = new ObjectOutputStream(
          this.myClientSocket.getOutputStream());
      ObjectInputStream inFromClient = new ObjectInputStream(
          this.myClientSocket.getInputStream());
      int loop = 0;
      String inputLine;
      ...
      while ((inputLine = (String) inFromClient.readObject()) != null)
      {
        ...
        if ((this.reqLocation.x > 0) && (this.reqLocation.x < 500) && (
            this.reqLocation.y > 0) && (this.reqLocation.y < 500))
        {
